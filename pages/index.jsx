...
const Home = () => {
  ...
  return (
    <div className="w-full h-full bg-black overflow-hidden">
      ...
      <div className="w-full lg:w-full h-fit justify-center items-center lg:flex-nowrap flex-wrap flex flex-row pb-7 px-56">
        <Footer />
        <FooterOne />
        <FooterTwo />
        <FooterThree />
      </div>
      <div className="w-full h-fit justify-start items-center flex flex-col">
