...
const Privacy = () => {
    const line = [
      ...
      {title:"payment service providers who provide us with payment or balance information, or updates to that information, based on their relationship with you"},
      {title:"online and offline data providers, from which we obtain aggregated demographic, interest based and online advertising related data"},
      {title:"publicly-available sources such as publicly available posts on social media platforms and information available through public databases associating IP addresses with internet service providers"},
      {title:"secure our systems, prevent fraud and help us protect the security of Netflix accounts"},
    ];
    return (
      <>
        <Head>
